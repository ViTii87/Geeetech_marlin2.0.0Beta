...
#define STRING_CONFIG_H_AUTHOR "(ViTii87, Geeetech Prusa i3 Pro B BLTouch config)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.81, 97.87, 1600, 505 }
